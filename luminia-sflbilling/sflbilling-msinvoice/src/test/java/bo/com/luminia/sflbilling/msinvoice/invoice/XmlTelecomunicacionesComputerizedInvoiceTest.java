...
public class XmlTelecomunicacionesComputerizedInvoiceTest {

    private XmlTelecomunicacionesCmpInvoice crearFactura() {
        XmlTelecomunicacionesHeader cabecera = new XmlTelecomunicacionesHeader();
        ...
        cabecera.setCodigoDocumentoSector(22);
        cabecera.setCodigoExcepcion(0);

        XmlTelecomunicacionesDetail d1 = new XmlTelecomunicacionesDetail();
        ...
        List<XmlTelecomunicacionesDetail> detalle = new ArrayList<>();
        detalle.add(d1);

        XmlTelecomunicacionesCmpInvoice invoice = null;
        try {
            invoice = new XmlTelecomunicacionesCmpInvoice();
    ...
    public  void testValidarFactura(){
        XmlTelecomunicacionesCmpInvoice factura = this.crearFactura();
        try {
    ...
    public void testGenerarFactura() {
        try {
            XmlTelecomunicacionesCmpInvoice invoice = this.crearFactura();
