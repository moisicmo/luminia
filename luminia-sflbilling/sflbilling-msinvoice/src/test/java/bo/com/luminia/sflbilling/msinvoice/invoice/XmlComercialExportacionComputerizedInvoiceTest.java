...
public class XmlComercialExportacionComputerizedInvoiceTest {

    private XmlComercialExportacionCmpInvoice crearFactura() {
        XmlComercialExportacionHeader cabecera = new XmlComercialExportacionHeader();
        ...
        XmlComercialExportacionDetail d1 = new XmlComercialExportacionDetail();
        ...
        List<XmlComercialExportacionDetail> detalle = new ArrayList<>();
        detalle.add(d1);

        XmlComercialExportacionCmpInvoice invoice = null;
        try {
            invoice = new XmlComercialExportacionCmpInvoice();
    ...
    public void testValidarFactura() {
        XmlComercialExportacionCmpInvoice factura = this.crearFactura();
        try {
    ...
    public void testGenerarFactura() {
        try {
            XmlComercialExportacionCmpInvoice invoice = this.crearFactura();
