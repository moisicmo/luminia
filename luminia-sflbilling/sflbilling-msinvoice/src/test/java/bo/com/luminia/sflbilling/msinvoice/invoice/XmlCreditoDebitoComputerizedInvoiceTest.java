...
public class XmlCreditoDebitoComputerizedInvoiceTest {

    private XmlNotaCreditoDebitoCmpInvoice crearFactura() {
        XmlNotaCreditoDebitoHeader cabecera = new XmlNotaCreditoDebitoHeader();
        ...
        cabecera.setNumeroNotaCreditoDebito(4343L);
        ...
        cabecera.setMontoTotalDevuelto(new BigDecimal(100));
        cabecera.setMontoDescuentoCreditoDebito(new BigDecimal(23));
        cabecera.setMontoEfectivoCreditoDebito(new BigDecimal(22));
        ...
        cabecera.setCodigoDocumentoSector(24);


        XmlNotaCreditoDebitoDetail d1 = new XmlNotaCreditoDebitoDetail();
        ...
        d1.setCodigoDetalleTransaccion(1);
        //d1setNumeroSerie()
        //d1.setNumeroImei();

        XmlNotaCreditoDebitoDetail d2 = new XmlNotaCreditoDebitoDetail();
        ...
        d2.setCantidad(new BigDecimal(10));
        d2.setUnidadMedida(58);
        d2.setPrecioUnitario(new BigDecimal(2.5));
        //d1.setMontoDescuento();
        d2.setSubTotal(new BigDecimal(25));
        d2.setCodigoDetalleTransaccion(1);
        //d1setNumeroSerie()
        //d1.setNumeroImei();

        List<XmlNotaCreditoDebitoDetail> detalle = new ArrayList<>();
        detalle.add(d1);
        detalle.add(d2);

        XmlNotaCreditoDebitoCmpInvoice invoice = null;
        try {
            invoice = new XmlNotaCreditoDebitoCmpInvoice();
    ...
    public  void testValidarFactura(){
        XmlNotaCreditoDebitoCmpInvoice factura = this.crearFactura();
        try {
    ...
    public void testGenerarFactura() {
        try {
            XmlNotaCreditoDebitoCmpInvoice invoice = this.crearFactura();
