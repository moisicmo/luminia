...
public class XmlSectorEducativoComputerizedInvoiceTest {

    private XmlSectorEducativoCmpInvoice crearFactura() {
        XmlSectorEducativoHeader cabecera = new XmlSectorEducativoHeader();
        ...
        cabecera.setNombreEstudiante("Marcelo Campos Vargas");
        cabecera.setPeriodoFacturado("JUNIO 2019");
        ...
        cabecera.setCodigoDocumentoSector(11);
        cabecera.setDescuentoAdicional(new BigDecimal(1));

        XmlSectorEducativoDetail d1 = new XmlSectorEducativoDetail();
        ...
        List<XmlSectorEducativoDetail> detalle = new ArrayList<>();
        detalle.add(d1);

        XmlSectorEducativoCmpInvoice invoice = null;
        try {
            invoice = new XmlSectorEducativoCmpInvoice();
    ...
    public  void testValidarFactura(){
        XmlSectorEducativoCmpInvoice factura = this.crearFactura();
        try {
    ...
    public void testGenerarFactura() {
        try {
            XmlSectorEducativoCmpInvoice invoice = this.crearFactura();
