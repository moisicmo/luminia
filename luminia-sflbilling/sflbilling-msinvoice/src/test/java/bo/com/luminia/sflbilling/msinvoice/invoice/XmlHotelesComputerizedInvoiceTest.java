...
public class XmlHotelesComputerizedInvoiceTest {

    private XmlHotelCmpInvoice crearFactura() {
        XmlHotelesHeader cabecera = new XmlHotelesHeader();
        ...
        cabecera.setMontoTotalSujetoIva(new BigDecimal(404));
        ...
        cabecera.setCodigoDocumentoSector(16);
        ...
        XmlHotelesDetail d1 = new XmlHotelesDetail();
        ...
        List<XmlHotelesDetail> detalle = new ArrayList<>();
        detalle.add(d1);

        XmlHotelCmpInvoice invoice = null;
        try {
            invoice = new XmlHotelCmpInvoice();
    ...
    public  void testValidarFactura(){
        XmlHotelCmpInvoice factura = this.crearFactura();
        try {
    ...
    public void testGenerarFactura() {
        try {
            XmlHotelCmpInvoice invoice = this.crearFactura();
