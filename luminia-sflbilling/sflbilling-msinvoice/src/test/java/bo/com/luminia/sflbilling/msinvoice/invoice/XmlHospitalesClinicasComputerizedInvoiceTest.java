...
public class XmlHospitalesClinicasComputerizedInvoiceTest {

    private XmlHospitalClinicaCmpInvoice crearFactura() {
        XmlHospitalClinicaHeader cabecera = new XmlHospitalClinicaHeader();
        ...
        cabecera.setCodigoDocumentoSector(17);
        cabecera.setCodigoExcepcion(0);

        cabecera.setModalidadServicio("Post Operatorio");

        XmlHospitalClinicaDetail d1 = new XmlHospitalClinicaDetail();
        ...
        d1.setEspecialidad("traumatologia");
        d1.setEspecialidadDetalle("Compostura de hueso");
        d1.setNroQuirofanoSalaOperaciones(2);
        d1.setEspecialidadMedico("traumatologia");
        d1.setNombreApellidoMedico("juan rodriguez");
        d1.setNitDocumentoMedico(44343434L);
        d1.setNroMatriculaMedico("dfd##4#4343");
        d1.setNroFacturaMedico(34343L);

        List<XmlHospitalClinicaDetail> detalle = new ArrayList<>();
        detalle.add(d1);

        XmlHospitalClinicaCmpInvoice invoice = null;
        try {
            invoice = new XmlHospitalClinicaCmpInvoice();
    ...
    public  void testValidarFactura(){
        XmlHospitalClinicaCmpInvoice factura = this.crearFactura();
        try {
    ...
    public void testGenerarFactura() {
        try {
            XmlHospitalClinicaCmpInvoice invoice = this.crearFactura();
