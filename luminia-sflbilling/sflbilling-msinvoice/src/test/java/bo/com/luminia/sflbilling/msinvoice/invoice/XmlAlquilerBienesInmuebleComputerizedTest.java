...
import bo.gob.impuestos.sfe.invoice.xml.cmp.XmlAlquilerBienesInmueblesCmpInvoice;
...
public class XmlAlquilerBienesInmuebleComputerizedTest {

    private XmlAlquilerBienesInmueblesCmpInvoice crearFactura() {
        XmlAlquilerBienesInmueblesHeader cabecera = new XmlAlquilerBienesInmueblesHeader();
        ...
        cabecera.setCodigoDocumentoSector(2);
        cabecera.setCodigoExcepcion(0);

        cabecera.setPeriodoFacturado("JUNIO");

        XmlAlquilerBienesInmueblesDetail d1 = new XmlAlquilerBienesInmueblesDetail();
        ...
        List<XmlAlquilerBienesInmueblesDetail> detalle = new ArrayList<>();
        detalle.add(d1);

        XmlAlquilerBienesInmueblesCmpInvoice invoice = null;
        try {
            invoice = new XmlAlquilerBienesInmueblesCmpInvoice();
    ...
    public  void testValidarFactura(){
        XmlAlquilerBienesInmueblesCmpInvoice factura = this.crearFactura();
        try {
    ...
    public void testGenerarFactura() {
        try {
            XmlAlquilerBienesInmueblesCmpInvoice invoice = this.crearFactura();
