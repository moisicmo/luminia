...
import bo.com.luminia.sflbilling.msbatch.web.rest.certification.request.InvoiceOfflineReq;
...
@SpringBootTest
public class TestEmisionPaqueteIT {
    ...
    public void test() throws Exception {
        ...
        int numberTests = 5;
        int numberInvoices = 500;
        long companyId = 1001;
        Integer branchOfficeSiat = 0;
        Integer pointSaleSiat = 1;
        String token = "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImF1dGgiOiJST0xFX0FETUlOLFJPTEVfVVNFUiIsImV4cCI6MTYzNTk1ODM5NH0.WvtaZeziZVadommoS4y2hh7XbxiSi65PACowkSPxUO5uEpwu-0RU8sp-xMNMxXsSKGOJG39kaofawWdv1iNlaQ";
...
//        }
        ...
        for (int significantEvent = 1; significantEvent <= 4; significantEvent++) {

            // Itera el numero de pruebas requeridas.
            for (int number = 1; number <= numberTests; number++) {

                // Configura el sistema para uso fuera de linea.
                InvoiceOfflineReq invoiceOfflineReq = new InvoiceOfflineReq();
                invoiceOfflineReq.setSignificantEventSiatId(significantEvent);
                invoiceOfflineReq.setDescription("CORTE DE INTERNET");
                ...
                HttpEntity<InvoiceOfflineReq> request = new HttpEntity<>(invoiceOfflineReq, headers);
                String result = restTemplate.postForObject("http://localhost:8082/api/invoice/offline", request, String.class);
                ...
                for (Integer sectorDocumentType : sectorDocumentTypeList) {
                    ...
                    for (int i = 1; i <= numberInvoices; i++) {
                        ...
                        HttpEntity<InvoiceIssueReq> request2 = new HttpEntity<>(requestInvoice, headers2);
                        String result2 = restTemplate2.postForObject("http://localhost:8082/api/invoice/issue", request2, String.class);
                    }
                }
