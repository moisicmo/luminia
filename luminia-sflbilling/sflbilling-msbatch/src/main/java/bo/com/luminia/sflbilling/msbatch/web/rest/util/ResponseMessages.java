...
public class ResponseMessages {
    ...
    public static final String ERROR_COMPANY_NOT_FOUND = "No se pudo encontrar la empresa <%d> o se encuentra inactiva.";
    public static final String ERROR_COMPANY_CODE_NOT_FOUND = "No se pudo encontrar la empresa <%s> o se encuentra inactiva.";
    public static final String ERROR_INVOICE_NOT_FOUND = "La factura <%s> no fue encontrada.";
