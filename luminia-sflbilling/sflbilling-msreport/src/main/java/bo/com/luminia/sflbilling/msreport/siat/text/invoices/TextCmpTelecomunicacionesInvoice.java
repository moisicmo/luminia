...
import bo.gob.impuestos.sfe.invoice.xml.cmp.XmlTelecomunicacionesCmpInvoice;
import bo.gob.impuestos.sfe.invoice.xml.detail.XmlTelecomunicacionesDetail;

import java.util.HashMap;

public class TextCmpTelecomunicacionesInvoice extends TextInvoice<XmlTelecomunicacionesCmpInvoice> {

    public TextCmpTelecomunicacionesInvoice(XmlTelecomunicacionesCmpInvoice invoice, String paperType) {
