...
public class PdfEltrInvoiceCompraVenta extends PdfInvoice<XmlCompraVentaEltrInvoice, XmlCompraVentaHeader> implements PdfProxy {

    public PdfEltrInvoiceCompraVenta(XmlCompraVentaEltrInvoice invoice, String paperType, Image logo) {
    ...
    public HashMap<String, Object> getDefaultParametersForHeader(XmlCompraVentaHeader xmlCompraVentaHeader)
