...
import bo.gob.impuestos.sfe.invoice.xml.cmp.XmlSectorEducativoCmpInvoice;
import bo.gob.impuestos.sfe.invoice.xml.detail.XmlSectorEducativoDetail;

import java.util.HashMap;

public class TextCmpSectorEducativoInvoice extends TextInvoice<XmlSectorEducativoCmpInvoice> {

    public TextCmpSectorEducativoInvoice(XmlSectorEducativoCmpInvoice invoice, String paperType) {
