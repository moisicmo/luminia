...
public class TextEntidadesFinancierasTemplate {
    /**
    ...
    public static final String FOOTER_A4 =
        "-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  - \n" +
            "                                                                       MONTO ARRENDAMIENTO FINANCIERO Bs.     ;<FTR_MONTO_ARREND>\n" +
    ...
    public static final String FOOTER_POS =
        "- - - - - - - - - - - - - - - -;" +
            "TOTAL ARR Bs.;<FTR_ARRENDAMIEN>;" +
            "DESC. Bs.;<FTR_MONTO_DESCUENTO>;" +
            "TOTAL Bs.    ;<FTR_MONTO_TOTAL>;" +
            "IMP.CRED.FISC.; <FTR_MONTO_IVA>;" +
            "Son:;" +
