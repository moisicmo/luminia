...
import bo.gob.impuestos.sfe.invoice.xml.eltr.XmlExportacionServicioEltrInvoice;

import java.util.HashMap;
import java.util.Optional;

public class TextEltrExportacionServiciosInvoice extends TextInvoice<XmlExportacionServicioEltrInvoice> {

    public TextEltrExportacionServiciosInvoice(XmlExportacionServicioEltrInvoice invoice, String paperType) {
    ...
    @Override
    protected String[] generateHeaderA4() throws PdfInvoiceCurrencyNotFoundException {
    ...
    @Override
    protected String[] generateHeaderPOS() throws PdfInvoiceCurrencyNotFoundException {
        parameters.put(TextInvoiceParameters.HDR_RAZON_SOCIAL_EMISOR, invoice.getCabecera().getRazonSocialEmisor());
        parameters.put(TextInvoiceParameters.HDR_DIRECCION, invoice.getCabecera().getDireccion());
        parameters.put(TextInvoiceParameters.HDR_TELEFONO, invoice.getCabecera().getTelefono());
        parameters.put(TextInvoiceParameters.HDR_MUNICIPIO, invoice.getCabecera().getMunicipio());
