...
public class TextComercializacionHidrocarburosTemplate {
    /**
     * Compra Venta A4
     */
    public static final String HEADER_A4 =
        "\n" +
            ...
            "Nombre/Razón Social : <HDR_NOMBRE_RAZON_SOCIAL>                        ;       TIPO ENVASE :<HDR_TIPO_ENVASE>                     ;\n" +
            "   Placa/B-Sisa/Vin : <HDR_PLACA_B_SISA_VIN>                           ; \n" +
            "\n" +
            "-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  \n" +
    ...
    public static final String FOOTER_A4 =
        "-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  - \n" +
            ...
            "                                                                           IMPORTE BASE C/C MONTO LEY Bs.      ;  <FTR_MONTO_LEY>\n" +
