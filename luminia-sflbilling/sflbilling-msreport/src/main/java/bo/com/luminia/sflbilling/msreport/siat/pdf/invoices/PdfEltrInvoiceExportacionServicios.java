...
public class PdfEltrInvoiceExportacionServicios extends PdfInvoice<XmlExportacionServicioEltrInvoice, XmlExportacionServiciosHeader> implements PdfProxy {

    private CurrencyTypeRepository repository;

    private ApplicationContext ctx;

    public PdfEltrInvoiceExportacionServicios(XmlExportacionServicioEltrInvoice invoice, String paperType, CurrencyTypeRepository repository, Image logo) {
