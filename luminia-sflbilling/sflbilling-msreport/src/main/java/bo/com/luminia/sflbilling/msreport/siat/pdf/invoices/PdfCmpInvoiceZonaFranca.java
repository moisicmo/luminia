...
public class PdfCmpInvoiceZonaFranca extends PdfInvoice<XmlZonaFrancaCmpInvoice, XmlZonaFrancaHeader> implements PdfProxy {

    public PdfCmpInvoiceZonaFranca(XmlZonaFrancaCmpInvoice invoice, String paperType, Image logo) {
    ...
    public HashMap<String, Object> getDefaultParametersForHeader(XmlZonaFrancaHeader header)
