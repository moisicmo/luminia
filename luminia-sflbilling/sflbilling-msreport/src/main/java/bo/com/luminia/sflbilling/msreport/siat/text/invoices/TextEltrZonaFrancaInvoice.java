...
public class TextEltrZonaFrancaInvoice extends TextInvoice<XmlZonaFrancaEltrInvoice> {

    public TextEltrZonaFrancaInvoice(XmlZonaFrancaEltrInvoice invoice, String paperType) {
    ...
    protected String[] generateFooterA4() {
        ...
        parameters.put(TextInvoiceParameters.FTR_MONEDA_LITERAL, "Bolivianos");
