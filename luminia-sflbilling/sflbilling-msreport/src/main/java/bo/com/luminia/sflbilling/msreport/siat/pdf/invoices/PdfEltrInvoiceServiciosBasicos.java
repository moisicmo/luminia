...
public class PdfEltrInvoiceServiciosBasicos extends PdfInvoice<XmlServiciosBasicosEltrInvoice, XmlServiciosBasicosHeader> implements PdfProxy {

    public PdfEltrInvoiceServiciosBasicos(XmlServiciosBasicosEltrInvoice invoice, String paperType, Image logo) {
    ...
    public HashMap<String, Object> getDefaultParametersForHeader(XmlServiciosBasicosHeader header)
        ...
        parameters.put(PdfInvoiceParameters.INVOICE_CONSUMO_PERIODO, header.getConsumoPeriodo().toString());
        ...
        parameters.put(PdfInvoiceParameters.INVOICE_BENEFICIARIO_LEY_1886, header.getBeneficiarioLey1886() == null ? "0.00" : header.getBeneficiarioLey1886().toString());
