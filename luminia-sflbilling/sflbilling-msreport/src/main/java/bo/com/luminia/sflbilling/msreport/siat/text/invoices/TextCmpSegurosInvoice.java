...
public class TextCmpSegurosInvoice extends TextInvoice<XmlSegurosCmpInvoice> {

    public TextCmpSegurosInvoice(XmlSegurosCmpInvoice invoice, String paperType) {
    ...
    protected String[] generateDetailsA4() {
        ...
        for (XmlSegurosDetail item : invoice.getDetalle()) {
