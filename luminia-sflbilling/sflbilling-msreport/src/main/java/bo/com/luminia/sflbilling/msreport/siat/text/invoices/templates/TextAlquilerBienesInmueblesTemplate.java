...
public class TextAlquilerBienesInmueblesTemplate {
    /**
     * Compra Venta A4
     */
    public static final String HEADER_A4 =
        "\n" +
            ...
            ";\n" +
            "                                             RECIBO DE ALQUILER DE BIENES E INMUEBLES\n" +
    ...
    public static final String FOOTER_A4 =
        "-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  - \n" +
            ...
            "                                                                          IMPORTE BASE CREDITO FISCAL Bs.       ; <FTR_MONTO_IVA>\n" +
    ...
    public static final String HEADER_POS =
        "RECIBO DE ALQUILER BIENES E;" +
            ...
            "<HDR_VALUE_4>;" +
            "- - - - - - - - - - - - - - - -;" +
            "NOMBRE/RAZON:<HDR_NOMBRE_RAZON_SOCIAL>;" +
