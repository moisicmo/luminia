...
public class PdfEltrInvoiceHoteles extends PdfInvoice<XmlHotelEltrInvoice, XmlHotelesHeader> implements PdfProxy {

    public PdfEltrInvoiceHoteles(XmlHotelEltrInvoice invoice, String paperType, Image logo) {
