...
public class PdfEltrInvoiceTelecomunicaciones extends PdfInvoice<XmlTelecomunicacionesEltrInvoice, XmlTelecomunicacionesHeader> implements PdfProxy {

    public PdfEltrInvoiceTelecomunicaciones(XmlTelecomunicacionesEltrInvoice invoice, String paperType, Image logo) {
        super(invoice, paperType, logo);
        this.fileName = String.format("/reports/facturaTelecomunicaciones_%s.jrxml", paperType);
        this.productCode = invoice.getDetalle().get(0).getCodigoProducto();
    }

    public HashMap<String, Object> getDefaultParametersForHeader(XmlTelecomunicacionesHeader xmlCompraVentaHeader)
