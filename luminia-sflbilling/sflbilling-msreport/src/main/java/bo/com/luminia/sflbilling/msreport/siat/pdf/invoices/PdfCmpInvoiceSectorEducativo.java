...
public class PdfCmpInvoiceSectorEducativo extends PdfInvoice<XmlSectorEducativoCmpInvoice, XmlSectorEducativoHeader> implements PdfProxy {

    public PdfCmpInvoiceSectorEducativo(XmlSectorEducativoCmpInvoice invoice, String paperType, Image logo) {
