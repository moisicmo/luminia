...
public class TextEltrSegurosInvoice extends TextInvoice<XmlSegurosEltrInvoice> {

    public TextEltrSegurosInvoice(XmlSegurosEltrInvoice invoice, String paperType) {
