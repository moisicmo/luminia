...
import bo.gob.impuestos.sfe.invoice.xml.cmp.XmlZonaFrancaCmpInvoice;
import bo.gob.impuestos.sfe.invoice.xml.detail.XmlZonaFrancaDetail;

import java.util.HashMap;

public class TextCmpZonaFrancaInvoice extends TextInvoice<XmlZonaFrancaCmpInvoice> {

    public TextCmpZonaFrancaInvoice(XmlZonaFrancaCmpInvoice invoice, String paperType) {
        ...
        if (paperType == TextInvoice.PAPER_A4) {
            ...
            this.details = TextCompraVentaTemplate.DETAILS_A4;
            this.footer = TextCompraVentaTemplate.FOOTER_A4;
        } else {
            this.header = TextCompraVentaTemplate.HEADER_POS;
            this.details = TextCompraVentaTemplate.DETAILS_POS;
            this.footer = TextCompraVentaTemplate.FOOTER_POS;
        }
    }
    ...
    protected String[] generateDetailsA4() {
        ...
        for (XmlZonaFrancaDetail item : invoice.getDetalle()) {
