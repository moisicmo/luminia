...
import bo.com.luminia.sflbilling.msreport.siat.text.invoices.templates.TextSeguridadAlimentariaTemplate;
...
import bo.gob.impuestos.sfe.invoice.xml.eltr.XmlAlimentariaAbastecimientoEltrInvoice;

import java.util.HashMap;

public class TextEltrSeguridadAlimentariaInvoice extends TextInvoice<XmlAlimentariaAbastecimientoEltrInvoice> {

    public TextEltrSeguridadAlimentariaInvoice(XmlAlimentariaAbastecimientoEltrInvoice invoice, String paperType) {
        ...
        if (paperType == TextInvoice.PAPER_A4) {
            if (invoice.getCabecera().getDireccion().length() > MAX_DIRECCION_LENGTH) {
                this.header = TextSeguridadAlimentariaTemplate.HEADER_A4_2;
            }else {
                this.header = TextSeguridadAlimentariaTemplate.HEADER_A4;
            }
            this.details = TextSeguridadAlimentariaTemplate.DETAILS_A4;
            this.footer = TextSeguridadAlimentariaTemplate.FOOTER_A4;
        } else {
            this.header = TextSeguridadAlimentariaTemplate.HEADER_POS;
            this.details = TextSeguridadAlimentariaTemplate.DETAILS_POS;
            this.footer = TextSeguridadAlimentariaTemplate.FOOTER_POS;
        }
    }
    ...
    protected String[] generateDetailsA4() {
        ...
        for (XmlAlimentariaAbastecimientoDetail item : invoice.getDetalle()) {
