...
public class TextEltrNotaDebitoInvoice extends TextInvoice<XmlNotaCreditoDebitoEltrInvoice> {

    private String footer_1, footer_2;

    public TextEltrNotaDebitoInvoice(XmlNotaCreditoDebitoEltrInvoice invoice, String paperType) {
