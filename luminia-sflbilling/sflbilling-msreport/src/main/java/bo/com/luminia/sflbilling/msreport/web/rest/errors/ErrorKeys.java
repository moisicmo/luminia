...
public final class ErrorKeys {
    ...
    public static final String ERR_CUIS_NOT_FOUND = "ERROR_CUIS_NOT_FOUND";
    public static final String ERR_CUFD_NOT_FOUND = "ERROR_CUDF_NOT_FOUND";
    ...
    public static final String REPORT_PDF_GENERATION = "REPORT_PDF_GENERATION";
    public static final String REPORT_DATA_GENERATION = "REPORT_DATA_GENERATION";
