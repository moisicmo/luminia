...
import bo.gob.impuestos.sfe.invoice.xml.eltr.XmlHospitalClinicaEltrInvoice;

import java.util.HashMap;

public class TextEltrHospitalesClinicasInvoice extends TextInvoice<XmlHospitalClinicaEltrInvoice> {

    public TextEltrHospitalesClinicasInvoice(XmlHospitalClinicaEltrInvoice invoice, String paperType) {
        ...
        if (paperType == TextInvoice.PAPER_A4) {
            if (invoice.getCabecera().getDireccion().length() > MAX_DIRECCION_LENGTH) {
                this.header = TextHospitalesClinicasTemplate.HEADER_A4_2;
            }else {
                this.header = TextHospitalesClinicasTemplate.HEADER_A4;
            }
