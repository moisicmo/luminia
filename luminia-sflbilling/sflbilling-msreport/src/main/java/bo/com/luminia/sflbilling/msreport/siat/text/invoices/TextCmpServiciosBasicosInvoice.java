...
public class TextCmpServiciosBasicosInvoice extends TextInvoice<XmlServiciosBasicosCmpInvoice> {

    public TextCmpServiciosBasicosInvoice(XmlServiciosBasicosCmpInvoice invoice, String paperType) {
