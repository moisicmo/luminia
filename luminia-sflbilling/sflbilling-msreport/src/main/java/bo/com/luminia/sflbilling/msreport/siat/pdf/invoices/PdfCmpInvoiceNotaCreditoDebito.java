...
public class PdfCmpInvoiceNotaCreditoDebito extends PdfInvoice<XmlNotaCreditoDebitoCmpInvoice, XmlNotaCreditoDebitoHeader> implements PdfProxy {

    public PdfCmpInvoiceNotaCreditoDebito(XmlNotaCreditoDebitoCmpInvoice invoice, String paperType, Image logo) {
    ...
    public byte[] generate() throws IOException, WriterException, JRException, URISyntaxException {
        ...
        parameters.put( PdfInvoiceParameters.INVOICE_MONTO_TOTAL, this.invoice.getCabecera().getMontoTotalDevuelto().toString());
    ...
    protected byte[] generateReportPdf(List<?> detail, HashMap<String, Object> parameters) throws FileNotFoundException,
        ...
        InputStream st1 = PdfCmpInvoiceNotaCreditoDebito.class.getResourceAsStream(String.format("/reports/datos_original_%s.jrxml", paperType));
        InputStream st2 = PdfCmpInvoiceNotaCreditoDebito.class.getResourceAsStream(String.format("/reports/devolucion_%s.jrxml", paperType));
