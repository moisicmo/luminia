...
import bo.gob.impuestos.sfe.invoice.xml.eltr.XmlConciliacionEltrInvoice;
...
public class PdfEltrInvoiceConciliacion extends PdfInvoice<XmlConciliacionEltrInvoice, XmlConciliacionHeader> implements PdfProxy {

    public PdfEltrInvoiceConciliacion(XmlConciliacionEltrInvoice invoice, String paperType, Image logo) {
    ...
    protected byte[] generateReportPdf(List<?> detail, List<?>conciliacion, HashMap<String, Object> parameters) throws FileNotFoundException, JRException, URISyntaxException {
        ...
        InputStream stream = PdfEltrInvoiceConciliacion.class.getResourceAsStream(this.fileName);
        ...
        InputStream stDatosOriginales = PdfEltrInvoiceConciliacion.class.getResourceAsStream(String.format("/reports/facturaConciliacion_%s_datosOriginales.jrxml", paperType));
        InputStream stDatosConciliacion = PdfEltrInvoiceConciliacion.class.getResourceAsStream(String.format("/reports/facturaConciliacion_%s_datosConciliacion.jrxml", paperType));
