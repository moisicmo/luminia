...
import bo.com.luminia.sflbilling.msreport.siat.text.invoices.templates.TextHospedajeTemplate;
...
public class TextEltrTuristicoHospedajeInvoice extends TextInvoice<XmlTuristicoHospedajeEltrInvoice> {

    public TextEltrTuristicoHospedajeInvoice(XmlTuristicoHospedajeEltrInvoice invoice, String paperType) {
        super(invoice, paperType);
        this.productCode = invoice.getDetalle().get(0).getCodigoProducto();
        if (paperType == TextInvoice.PAPER_A4) {
            this.header = TextHospedajeTemplate.HEADER_A4;
            this.details = TextHospedajeTemplate.DETAILS_A4;
            this.footer = TextHospedajeTemplate.FOOTER_A4;
        } else {
            this.header = TextHospedajeTemplate.HEADER_POS;
            this.details = TextHospedajeTemplate.DETAILS_POS;
            this.footer = TextHospedajeTemplate.FOOTER_POS;
        }
    }
    ...
    protected String[] generateDetailsA4() {
        ...
        for (XmlTuristicoHospedajeDetail item : invoice.getDetalle()) {
