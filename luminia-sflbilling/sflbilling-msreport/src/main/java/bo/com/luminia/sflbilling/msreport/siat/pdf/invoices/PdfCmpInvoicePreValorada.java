...
public class PdfCmpInvoicePreValorada extends PdfInvoice<XmlPrevaloradaCmpInvoice, XmlPrevaloradaHeader> implements PdfProxy {

    public PdfCmpInvoicePreValorada(XmlPrevaloradaCmpInvoice invoice, String paperType, Image logo) {
