...
public class PdfEltrInvoiceHospitalesClinicas extends PdfInvoice<XmlHospitalClinicaEltrInvoice, XmlHospitalClinicaHeader> implements PdfProxy {

    public PdfEltrInvoiceHospitalesClinicas(XmlHospitalClinicaEltrInvoice invoice, String paperType, Image logo) {
