...
public class TextCmpCompraVentaInvoice extends TextInvoice<XmlCompraVentaCmpInvoice> {

    public TextCmpCompraVentaInvoice(XmlCompraVentaCmpInvoice invoice, String paperType) {
    ...
    protected String[] generateDetailsA4() {
        for (XmlCompraVentaDetail item : invoice.getDetalle()) {
