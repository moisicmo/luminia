...
import bo.com.luminia.sflbilling.msreport.siat.text.invoices.templates.TextTelecomunicacionesTemplate;
...
import bo.gob.impuestos.sfe.invoice.xml.eltr.XmlTelecomunicacionesEltrInvoice;

import java.util.HashMap;

public class TextEltrTelecomunicacionesInvoice extends TextInvoice<XmlTelecomunicacionesEltrInvoice> {

    public TextEltrTelecomunicacionesInvoice(XmlTelecomunicacionesEltrInvoice invoice, String paperType) {
        ...
        if (paperType == TextInvoice.PAPER_A4) {
            if (invoice.getCabecera().getDireccion().length() > MAX_DIRECCION_LENGTH) {
                this.header = TextTelecomunicacionesTemplate.HEADER_A4_2;
            }else {
                this.header = TextTelecomunicacionesTemplate.HEADER_A4;
            }
            this.details = TextTelecomunicacionesTemplate.DETAILS_A4;
            this.footer = TextTelecomunicacionesTemplate.FOOTER_A4;
        } else {
            this.header = TextTelecomunicacionesTemplate.HEADER_POS;
            this.details = TextTelecomunicacionesTemplate.DETAILS_POS;
            this.footer = TextTelecomunicacionesTemplate.FOOTER_POS;
        }
    }
    ...
    protected String[] generateDetailsA4() {
        for (XmlTelecomunicacionesDetail item : invoice.getDetalle()) {
