...
import bo.gob.impuestos.sfe.invoice.xml.cmp.XmlComercialExportacionCmpInvoice;
...
public class TextCmpComercialExportacionInvoice extends TextInvoice<XmlComercialExportacionCmpInvoice> {
    ...
    public TextCmpComercialExportacionInvoice(XmlComercialExportacionCmpInvoice invoice, String paperType) {
    ...
    protected String[] generateHeaderA4() {
        ...
        parameters.put(TextInvoiceParameters.HDR_MONEDA_TRANSACCION, TextInvoice.BOLIVIANOS);
    ...
    protected String[] generateFooterA4_3() {
        ...
        parameters.put(TextInvoiceParameters.FTR_MONEDA_LITERAL, TextInvoice.BOLIVIANOS);
        parameters.put(TextInvoiceParameters.FTR_TOTAL_MONEDA, TextInvoice.BOLIVIANOS);
        parameters.put(TextInvoiceParameters.FTR_SUBTOTAL_MONEDA, TextInvoice.BOLIVIANOS);
        parameters.put(TextInvoiceParameters.FTR_DESCUENTO_MONEDA, TextInvoice.BOLIVIANOS);
