...
public class PdfCmpInvoiceComercialExportacion extends PdfInvoice<XmlComercialExportacionCmpInvoice, XmlComercialExportacionHeader> implements PdfProxy {

    private CurrencyTypeRepository repository;

    public PdfCmpInvoiceComercialExportacion(XmlComercialExportacionCmpInvoice invoice, String paperType,
    ...
    public HashMap<String, Object> getDefaultParametersForHeader(XmlComercialExportacionHeader header)
        ...
        parameters.put(PdfInvoiceParameters.INVOICE_SUBTOTAL_TIPO_CAMBIO, header.getMontoTotalSujetoIva().toString());
        parameters.put(PdfInvoiceParameters.INVOICE_DESCUENTO_TIPO_CAMBIO, header.getDescuentoAdicional().toString());
