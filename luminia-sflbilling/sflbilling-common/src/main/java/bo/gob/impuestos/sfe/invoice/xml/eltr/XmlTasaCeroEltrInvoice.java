...
@XmlRootElement(name = "facturaElectronicaTasaCero")
public class XmlTasaCeroEltrInvoice extends XmlBaseInvoice<XmlTasaCeroHeader, XmlTasaCeroDetail> {

    public XmlTasaCeroEltrInvoice() throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_ELE_TASA_CERO);
    }
