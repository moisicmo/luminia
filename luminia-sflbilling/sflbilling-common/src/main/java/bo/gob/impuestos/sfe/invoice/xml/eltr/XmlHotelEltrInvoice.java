 ...
 */
@XmlType
@XmlRootElement(name = "facturaElectronicaHotel")
public class XmlHotelEltrInvoice
    extends XmlBaseInvoice<XmlHotelesHeader, XmlHotelesDetail> {

    public XmlHotelEltrInvoice()throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_ELE_HOTELES);
    }
