...
public class XmlTelecomunicacionesHeader extends XmlBaseHeaderInvoice {

    private Long nitConjunto;

    @XmlElement(name = "nitConjunto",nillable = true)
    ...
    public void convert(Map<String, Object> header) {
        ...
        if (header.containsKey(XmlTags.HEADER_NIT_CONJUNTO)) {
            this.setNitConjunto(Long.parseLong((String) header.get(XmlTags.HEADER_NIT_CONJUNTO)));
        }
    }
}
