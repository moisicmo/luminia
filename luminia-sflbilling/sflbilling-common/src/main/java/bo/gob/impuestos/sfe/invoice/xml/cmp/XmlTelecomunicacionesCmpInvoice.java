...
@XmlRootElement(name = "facturaComputarizadaTelecomunicacion")
@XmlType
public class XmlTelecomunicacionesCmpInvoice
    extends XmlBaseInvoice<XmlTelecomunicacionesHeader, XmlTelecomunicacionesDetail>
{
    public XmlTelecomunicacionesCmpInvoice() throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_CMP_TELECOMUNICACIONES);
    }
