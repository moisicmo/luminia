...
@XmlType(propOrder = {"nitEmisor", "razonSocialEmisor", "municipio", "telefono", "numeroFactura", "cuf", "cufd",
        ...
        "numeroDocumento", "complemento", "codigoCliente", "codigoMetodoPago", "numeroTarjeta", "montoTotal", "ajusteAfectacionIva",
...
public class XmlSegurosHeader extends XmlBaseHeaderInvoice {

    @NotNull
    private BigDecimal ajusteAfectacionIva;
    ...
    @XmlElement(name = "ajusteAfectacionIva", required = true)
    public BigDecimal getAjusteAfectacionIva() {
        return ajusteAfectacionIva != null ? ajusteAfectacionIva.setScale(2, BigDecimal.ROUND_HALF_EVEN) : null;
    }
    ...
    public void convert(Map<String, Object> fromValues) {
        ...
        this.setAjusteAfectacionIva(new BigDecimal((String) fromValues.get(XmlTags.HEADER_AJUSTE_AFECTACION_IVA)));
    }
}
