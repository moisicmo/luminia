 ...
 * 
 */
@WebServiceClient(name = "ServicioFacturacion", targetNamespace = "https://siat.impuestos.gob.bo/ServicioFacturacionDocumentoAjuste", wsdlLocation = "https://pilotosiatservicios.impuestos.gob.bo/v2/ServicioFacturacionDocumentoAjuste?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOFACTURACION_QNAME = new QName("https://siat.impuestos.gob.bo/ServicioFacturacionDocumentoAjuste", "ServicioFacturacion");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://pilotosiatservicios.impuestos.gob.bo/v2/ServicioFacturacionDocumentoAjuste?wsdl");
    ...
    public ServicioFacturacion getServicioFacturacionPort() {
        return super.getPort(new QName("https://siat.impuestos.gob.bo/ServicioFacturacionDocumentoAjuste", "ServicioFacturacionPort"), ServicioFacturacion.class);
    }
    ...
    public ServicioFacturacion getServicioFacturacionPort(WebServiceFeature... features) {
        return super.getPort(new QName("https://siat.impuestos.gob.bo/ServicioFacturacionDocumentoAjuste", "ServicioFacturacionPort"), ServicioFacturacion.class, features);
    }
