...
@XmlType
@XmlRootElement(name = "facturaComputarizadaHospitalClinica")
public class XmlHospitalClinicaCmpInvoice
    extends XmlBaseInvoice<XmlHospitalClinicaHeader, XmlHospitalClinicaDetail> {

    public XmlHospitalClinicaCmpInvoice() throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_CMP_HOSPITAL_CLINICA);
    }
