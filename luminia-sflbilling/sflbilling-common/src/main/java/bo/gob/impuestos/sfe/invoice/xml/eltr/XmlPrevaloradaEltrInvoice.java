...
@XmlRootElement(name = "facturaElectronicaPrevalorada")
public class XmlPrevaloradaEltrInvoice
        extends XmlBaseInvoice<XmlPrevaloradaHeader, XmlPrevaloradaDetail> {

    public XmlPrevaloradaEltrInvoice() throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_ELE_PREVALORADA);
    }
