...
@XmlRootElement(name ="facturaElectronicaSectorEducativo" )
public class XmlSectorEducativoEltrInvoice
    extends XmlBaseInvoice<XmlSectorEducativoHeader, XmlSectorEducativoDetail> {

    public XmlSectorEducativoEltrInvoice()throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_ELE_SECTOR_EDUCATIVO );
    }
