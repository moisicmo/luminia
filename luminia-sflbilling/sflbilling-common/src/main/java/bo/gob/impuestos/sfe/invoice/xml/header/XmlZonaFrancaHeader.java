...
@XmlType(propOrder = {"nitEmisor", "razonSocialEmisor", "municipio", "telefono", "numeroFactura", "cuf", "cufd",
        ...
        "codigoMoneda", "tipoCambio", "montoTotalMoneda", "numeroParteRecepcion",
        "montoGiftCard", "descuentoAdicional", "codigoExcepcion", "cafc",
        "leyenda", "usuario", "codigoDocumentoSector"})
public class XmlZonaFrancaHeader extends XmlBaseHeaderInvoice {

    @Size(min = 0, max = 500)
    private String numeroParteRecepcion;
    ...
    @XmlElement(name = "numeroParteRecepcion", required = false, nillable = true)
    public String getNumeroParteRecepcion() {
        return numeroParteRecepcion;
    }
    ...
    public void convert(Map<String, Object> fromValues) {
        ...
        this.setNumeroParteRecepcion((String) fromValues.get(XmlTags.HEADER_NUMERO_PARTE_RECEPCION));
    }
}
