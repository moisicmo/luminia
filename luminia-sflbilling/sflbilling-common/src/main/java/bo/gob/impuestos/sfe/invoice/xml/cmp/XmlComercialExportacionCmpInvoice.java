...
@XmlType
@XmlRootElement(name = "facturaComputarizadaComercialExportacion")
public class XmlComercialExportacionCmpInvoice
        extends XmlBaseInvoice<XmlComercialExportacionHeader, XmlComercialExportacionDetail> {

    public XmlComercialExportacionCmpInvoice() throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_CMP_COMERCIAL_EXPORTACION);
    }
