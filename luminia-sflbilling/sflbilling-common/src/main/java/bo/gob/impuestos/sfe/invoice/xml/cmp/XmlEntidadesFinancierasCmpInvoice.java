...
@XmlRootElement(name = "facturaComputarizadaEntidadFinanciera")
@XmlType
public class XmlEntidadesFinancierasCmpInvoice
    extends XmlBaseInvoice<XmlEntidadesFinancierasHeader, XmlEntidadesFinancierasDetail> {

    public XmlEntidadesFinancierasCmpInvoice() throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_CMP_ENTIDAD_FINANCIERA);
    }
