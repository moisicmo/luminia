...
@XmlType
@XmlRootElement(name = "facturaComputarizadaAlquilerBienInmueble")
public class XmlAlquilerBienesInmueblesCmpInvoice
    extends XmlBaseInvoice<XmlAlquilerBienesInmueblesHeader, XmlAlquilerBienesInmueblesDetail> {

    public XmlAlquilerBienesInmueblesCmpInvoice() throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_CMP_ALQUILER_BIENES_INMUEBLES);
    }
