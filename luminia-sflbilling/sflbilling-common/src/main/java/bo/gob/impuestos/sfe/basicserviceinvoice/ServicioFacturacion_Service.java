 ...
 * 
 */
@WebServiceClient(name = "ServicioFacturacion", targetNamespace = "https://siat.impuestos.gob.bo/ServicioFacturacionServicioBasico", wsdlLocation = "https://pilotosiatservicios.impuestos.gob.bo/v2/ServicioFacturacionServicioBasico?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOFACTURACION_QNAME = new QName("https://siat.impuestos.gob.bo/ServicioFacturacionServicioBasico", "ServicioFacturacion");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://pilotosiatservicios.impuestos.gob.bo/v2/ServicioFacturacionServicioBasico?wsdl");
    ...
    public ServicioFacturacion getServicioFacturacionPort() {
        return super.getPort(new QName("https://siat.impuestos.gob.bo/ServicioFacturacionServicioBasico", "ServicioFacturacionPort"), ServicioFacturacion.class);
    }
    ...
    public ServicioFacturacion getServicioFacturacionPort(WebServiceFeature... features) {
        return super.getPort(new QName("https://siat.impuestos.gob.bo/ServicioFacturacionServicioBasico", "ServicioFacturacionPort"), ServicioFacturacion.class, features);
    }
