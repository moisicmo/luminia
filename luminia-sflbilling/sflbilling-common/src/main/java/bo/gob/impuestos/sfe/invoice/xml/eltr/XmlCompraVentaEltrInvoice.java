...
public class XmlCompraVentaEltrInvoice
    extends XmlBaseInvoice<XmlCompraVentaHeader, XmlCompraVentaDetail> {

    public XmlCompraVentaEltrInvoice()throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_ELE_COMPRA_VENTA);
    }
