...
@XmlType(propOrder = {"nitEmisor", "razonSocialEmisor", "municipio","telefono","numeroFactura","cuf","cufd",
    ...
    "razonSocialOperadorTurismo","cantidadHuespedes","cantidadHabitaciones","cantidadMayores","cantidadMenores","fechaIngresoHospedaje",
...
public class XmlTuristicoHospedajeHeader extends XmlBaseHeaderInvoice {

    @Size(min = 0, max = 500)
    private String razonSocialOperadorTurismo;
    ...
    @XmlElement(name = "razonSocialOperadorTurismo",nillable = true)
    public String getRazonSocialOperadorTurismo() {
        return razonSocialOperadorTurismo;
    }
    ...
    @XmlElement(name = "montoTotalSujetoIva", required = true, defaultValue = "0")
    public BigDecimal getMontoTotalSujetoIva() {
        return montoTotalSujetoIva!= null ? montoTotalSujetoIva.setScale(2, BigDecimal.ROUND_HALF_EVEN): new BigDecimal(0);
    }
    ...
    public void convert(Map<String, Object> header) {
        ...
        this.setRazonSocialOperadorTurismo((String) header.get(XmlTags.HEADER_RAZON_SOCIAL_OPERADOR_TURISMO));
        ...
        if (header.containsKey(XmlTags.HEADER_FECHA_INGRESO_HOSPEDAJE)){
            this.setFechaIngresoHospedaje(XmlDateUtil.parseDateToYyyymmddThhmmssSSS( (String) header.get(XmlTags.HEADER_FECHA_INGRESO_HOSPEDAJE)));
        }
    }
}
