 ...
 * 
 */
@WebServiceClient(name = "ServicioFacturacion", targetNamespace = "https://siat.impuestos.gob.bo/ServicioFacturacionComputarizada", wsdlLocation = "https://pilotosiatservicios.impuestos.gob.bo/v2/ServicioFacturacionComputarizada?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOFACTURACION_QNAME = new QName("https://siat.impuestos.gob.bo/ServicioFacturacionComputarizada", "ServicioFacturacion");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://pilotosiatservicios.impuestos.gob.bo/v2/ServicioFacturacionComputarizada?wsdl");
    ...
    public ServicioFacturacion getServicioFacturacionPort() {
        return super.getPort(new QName("https://siat.impuestos.gob.bo/ServicioFacturacionComputarizada", "ServicioFacturacionPort"), ServicioFacturacion.class);
    }
    ...
    public ServicioFacturacion getServicioFacturacionPort(WebServiceFeature... features) {
        return super.getPort(new QName("https://siat.impuestos.gob.bo/ServicioFacturacionComputarizada", "ServicioFacturacionPort"), ServicioFacturacion.class, features);
    }
