...
@XmlType
@XmlRootElement(name = "notaComputarizadaConciliacion")
public class XmlConciliacionCmpInvoice extends XmlBaseInvoice<XmlConciliacionHeader, XmlConciliacionOriginalDetail> {

    private List<XmlConciliacionDetail> detalleConciliacion;

    public XmlConciliacionCmpInvoice() throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_CMP_NOTA_CONCILIACION);
    }
    ...
    public void convert(Map<String, Object> fromHeader, List<Map<String, String>> fromDetail, List<Map<String, String>> fromDetailConciliacion) {
        this.convert(fromHeader, fromDetail);
