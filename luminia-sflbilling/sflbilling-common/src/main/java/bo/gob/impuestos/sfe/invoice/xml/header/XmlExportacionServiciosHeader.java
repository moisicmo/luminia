...
@XmlType(propOrder = {"nitEmisor", "razonSocialEmisor", "municipio", "telefono", "numeroFactura", "cuf", "cufd",
        ...
        "direccionComprador",
        "codigoCliente",
        "lugarDestino", "codigoPais",
        "codigoMetodoPago", "numeroTarjeta", "montoTotal", "montoTotalSujetoIva",
        "codigoMoneda", "tipoCambio", "montoTotalMoneda", "informacionAdicional", "descuentoAdicional",
        "codigoExcepcion", "cafc",
        "leyenda", "usuario", "codigoDocumentoSector"})
public class XmlExportacionServiciosHeader extends XmlBaseHeaderInvoice {
    @NotBlank
    @Size(min = 1, max = 500)
    ...
    public BigDecimal getMontoTotalSujetoIva() {
        return montoTotalSujetoIva != null ? montoTotalSujetoIva.setScale(2, BigDecimal.ROUND_HALF_EVEN) : new BigDecimal(0).setScale(2);
    }
