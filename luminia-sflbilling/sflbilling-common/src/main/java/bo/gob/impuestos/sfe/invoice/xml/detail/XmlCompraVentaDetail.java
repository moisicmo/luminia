...
public class XmlCompraVentaDetail extends XmlBaseDetailInvoice {
    ...
    public void convert (Map<String, String> fromValues){
        this.convertToDetailBase(fromValues) ;

        this.setNumeroImei(fromValues.get(XmlTags.DETAIL_NUMERO_IMEI));
        this.setNumeroSerie(fromValues.get(XmlTags.DETAIL_NUMERO_SERIE));
    }
