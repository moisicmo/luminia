...
@XmlType(propOrder = {"nitEmisor", "razonSocialEmisor", "municipio", "telefono", "numeroFactura", "cuf", "cufd",
        ...
        "nombreEstudiante", "periodoFacturado",
...
public class XmlSectorEducativoHeader extends XmlBaseHeaderInvoice {
    ...
    @XmlElement(name = "nombreEstudiante")
    ...
    public void convert(Map<String, Object> fromValues) {
        ...
        this.setNombreEstudiante( (String) fromValues.get(XmlTags.HEADER_NOMBRE_ESTUDIANTE));
        this.setPeriodoFacturado( (String) fromValues.get(XmlTags.HEADER_PERIODO_FACTURADO));
    }
}
