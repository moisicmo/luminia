...
@XmlType
@XmlRootElement(name = "facturaElectronicaSeguridadAlimentaria")
public class XmlAlimentariaAbastecimientoEltrInvoice
    extends XmlBaseInvoice<XmlAlimentariaAbastecimientoHeader, XmlAlimentariaAbastecimientoDetail> {

    public XmlAlimentariaAbastecimientoEltrInvoice() throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_ELE_SEGURIDAD_ALIMENTARIA);
    }
