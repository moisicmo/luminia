...
@Setter
@XmlType(propOrder = {"actividadEconomica", "codigoProductoSin", "codigoProducto",
    "codigoTipoHabitacion", "descripcion", "cantidad", "unidadMedida",
    "precioUnitario", "montoDescuento", "subTotal",
    "detalleHuespedes"
})
public class XmlHotelesDetail extends XmlBaseDetailInvoice {
