...
public class XmlHidrocarburosHeader extends XmlBaseHeaderInvoice{
    ...
    @NotNull
    private BigDecimal montoTotalSujetoIvaLey317;
    ...
    @XmlElement(name = "tipoEnvase", nillable = true)
    public String getTipoEnvase() {
        return tipoEnvase;
    }
    @XmlElement(name = "montoTotalSujetoIvaLey317")
    public BigDecimal getMontoTotalSujetoIvaLey317() {
        return montoTotalSujetoIvaLey317!= null ? montoTotalSujetoIvaLey317.setScale(2,BigDecimal.ROUND_HALF_EVEN):null;
    }
    ...
    public void convert(Map<String, Object> header) {
        ...
        this.setPlacaVehiculo( (String) header.get(XmlTags.HEADER_PLACA_VEHICULO));
        this.setTipoEnvase( (String) header.get(XmlTags.HEADER_TIPO_ENVASE));
        if(header.containsKey(XmlTags.HEADER_MONTO_TOTAL_SUJETO_IVA_LEY_317)){
            this.setMontoTotalSujetoIvaLey317(new BigDecimal( (String) header.get(XmlTags.HEADER_MONTO_TOTAL_SUJETO_IVA_LEY_317)));
        }
    }
}
