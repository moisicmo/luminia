...
@XmlType
@XmlRootElement(name = "notaFiscalComputarizadaCreditoDebito")
public class XmlNotaCreditoDebitoCmpInvoice
    extends XmlBaseInvoice<XmlNotaCreditoDebitoHeader, XmlNotaCreditoDebitoDetail> {

    public XmlNotaCreditoDebitoCmpInvoice() throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_CMP_NOTA_CREDITO_DEBITO);
    }
