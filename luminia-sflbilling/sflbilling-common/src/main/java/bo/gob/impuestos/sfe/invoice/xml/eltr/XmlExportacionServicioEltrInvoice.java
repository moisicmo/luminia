...
@XmlType
@XmlRootElement(name = "facturaElectronicaComercialExportacionServicio")
public class XmlExportacionServicioEltrInvoice
    extends XmlBaseInvoice<XmlExportacionServiciosHeader, XmlExportacionServiciosDetail> {

    public XmlExportacionServicioEltrInvoice() throws FileNotFoundException, URISyntaxException {
        super(XmlNoNamespace.SCHEMA_LOCATION_ELE_EXPORTACION_SERVICIOS );
    }
