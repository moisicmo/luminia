...
public class XmlHospitalClinicaHeader extends XmlBaseHeaderInvoice{

    @Size(min = 0 , max = 100)
    private String modalidadServicio;

    @XmlElement(name = "modalidadServicio", nillable = true)
    ...
    public void convert(Map<String, Object> header) {
        ...
        this.setModalidadServicio((String)header.get(XmlTags.HEADER_MODALIDAD_SERVICIO));
    }
}
